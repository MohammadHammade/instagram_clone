...
createTrackingBall("rgba(255,255,255,0.5"); // console.log(document.getElementsByClassName("tracking-ball"));

document.onmousemove = function (e) {
  var arr = document.getElementsByClassName("tracking-ball");
